...
export default async function Services({ lang }: { lang: string }) {
    return (
        <section
            id="services"
            className="scroll-mt-20 bg-neutral-100 px-5 py-10 text-center md:px-20 lg:px-36">
            ...
            <div className="mb-1 mt-5 flex items-center justify-center gap-2">
                <p>Interested?</p>
                <button className="rounded bg-primary p-2 px-4 text-white transition hover:scale-105">
                    {"Let's begin working!"}
                </button>
            </div>
            <p>
