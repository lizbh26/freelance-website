...
export default function MobileNavigationMenu({
    ...
    return (
        <div className="md:hidden">
            ...
            <div
                className={`absolute left-0 mt-8 h-screen w-screen overflow-hidden shadow-sm backdrop-blur-sm transition-all duration-300 ${isOpen ? 'translate-x-0' : '-translate-x-full'}`}>
                <div
                    ref={menuRef}
