...
export default function LanguagePicker({ lang }: { lang: string }) {
    ...
    return (
        <div className="md:relative" ref={menuRef}>
            ...
            <div
                className={`absolute right-0 mt-10 w-1/2 min-w-44 overflow-hidden bg-white shadow-sm transition-all duration-300 sm:w-1/3 md:-left-12 md:right-auto md:w-auto md:min-w-36 lg:mt-8 ${isOpen ? 'translate-x-0 md:max-h-screen' : 'translate-x-full md:max-h-0 md:translate-x-0'}`}>
